...
export default function Dashboard() {
  ...
  return (
    <Layout title="Dashboard">
      {/* Welcome Section */}
      <div className="bg-[#003366] rounded-lg shadow-md p-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-200">{t('Last login')}: {format(new Date(), 'PPp')}</p>
          </div>
          <div className="mt-4 md:mt-0">
            <button className="bg-white text-[#003366] px-4 py-2 rounded font-semibold hover:bg-gray-100 transition-colors">
              {t('Academic Calendar')}
            </button>
          </div>
        </div>
